...
for (const required of ["index.html", "404.html", "echo/index.html"]) if (!fs.existsSync(path.join(rootOutput, required))) throw new Error(`Static export is missing ${required}.`);
